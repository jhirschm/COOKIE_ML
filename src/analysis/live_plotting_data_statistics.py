...
def analyze_data():
    ...
    cos_phase_differences = np.cos(phase_differences)
    ...
    ax_hist2.hist(cos_phase_differences, bins=50, color='green', alpha=0.7)
    ax_hist2.set_title('Histogram of cos(phase_diff)')
    ax_hist2.set_xlabel('cos(phase_diff) ')
