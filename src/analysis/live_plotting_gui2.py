...
def update_plot(*args):
    ...
    with h5py.File(full_path, 'r') as h5_file:
        ...
        energies = round(attributes['energies'], 3)  # Round energy to 3 decimal places
        phases = [round(phase, 3) for phase in attributes['phases']]  # Round phases to 3 decimal places
