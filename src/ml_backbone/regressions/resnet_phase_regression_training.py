...
def main():
    ...
    data_train = DataMilking_MilkCurds(root_dirs=[datapath_train], input_name="Ypdf", pulse_handler=None, transform=None, pulse_threshold=4, test_batch=4, zero_to_one_rescale=False, phases_labeled=True, phases_labeled_max=1)
    ...
    max_epochs = 200
    scheduler = CustomScheduler(optimizer, patience=3, early_stop_patience = 10, cooldown=2, lr_reduction_factor=0.1, max_num_epochs = max_epochs, improvement_percentage=0.001)
