...
case "$1" in
    training)
        python3 /sdf/home/j/jhirschm/COOKIE_ML/src/ml_backbone/regressions/pulse_singlePhase_regression_training.py
        ;;
    
    evaluation)
        python3 /sdf/home/j/jhirschm/COOKIE_ML/src/ml_backbone/regressions/pulse_singlePhase_regression_evaluation.py
        ;;
    *)
