...
def main():
    ...
    model = RegressionModel(fc_layers=fc_layers, 
    ...
    data_train = DataMilking_MilkCurds(root_dirs=[datapath_train], input_name="Ximg", pulse_handler=None, test_batch=1, transform=None,pulse_threshold=4, test_batch=1,zero_to_one_rescale=False, phases_labeled=True, phases_labeled_max=2, inverse_radon=False)
    ...
    model_save_dir = "/sdf/data/lcls/ds/prj/prjs2e21/results/COOKIE_ML_Output/regression/run_09092024_CNN_Ximg_Denoised"
    ...
    identifier = "CNN_XimgDenoised_wrapping_1"
