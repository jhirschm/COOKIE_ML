    ...
    training)
        case "$pulse_type" in
            single_pulse)
                ...
                ;;
            double_pulse)
                python3 /sdf/home/j/jhirschm/COOKIE_ML/src/ml_backbone/regressions/cnn_2pulse_phase_regression_training.py
                ;;
            *)
    ...
    evaluation)
        case "$pulse_type" in
            single_pulse)
                ...
                ;;
            double_pulse)
                python3 /sdf/home/j/jhirschm/COOKIE_ML/src/ml_backbone/regressions/cnn_2pulse_phase_regression_evaluation.py
                ;;
            *)
                echo "Invalid pulse type specified. Usage: sbatch this_script.sh [training|evaluation] [single_pulse|double_pulse]"
                exit 1
