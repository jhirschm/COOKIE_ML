...
def main():
    ...
    model_save_dir = "/sdf/data/lcls/ds/prj/prjs2e21/results/COOKIE_ML_Output/lstm_classifier/run_07042024_1/evalOutputs"
    ...
    best_mode_classifier = "/sdf/data/lcls/ds/prj/prjs2e21/results/COOKIE_ML_Output/lstm_classifier/run_07042024_1/testLSTM_best_model.pth"
    ...
    autoencoder.to(device)
    zero_model.to(device)
    classModel.evaluate_model(self, test_dataloader, identifier, model_save_dir, device, denoising=True, denoise_model = autoencoder, zero_mask_model = zero_model)
