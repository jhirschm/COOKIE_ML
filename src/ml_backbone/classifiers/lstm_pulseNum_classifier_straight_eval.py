...
def main():
    ...
    datapath1 = (
        "/sdf/data/lcls/ds/prj/prjs2e21/results/1-Pulse_03282024/Processed_06252024/"
    )
    ...
    data_test = DataMilking_MilkCurds(
        root_dirs=[datapath_test],
        input_name="Ximg",
        pulse_handler=None,
        transform=None,
        pulse_threshold=5,
    ...
    train_dataset, val_dataset, test_dataset = random_split(
        data_test, [train_size, val_size, test_size]
    )
