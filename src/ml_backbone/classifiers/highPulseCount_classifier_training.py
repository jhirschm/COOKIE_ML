...
def main():
    ...
    fc_layers = [
        [nn.Linear(output_size[1] * output_size[2] * output_size[3], 8), nn.ReLU()],
        [nn.Linear(8, 1), None]
    ]
    ...
    model_save_dir = "/sdf/data/lcls/ds/prj/prjs2e21/results/COOKIE_ML_Output/lstm_classifier/run_07292024_highPulseCountClassifier_2/"
    ...
    with open(results_file, 'w') as f:
        ...
        f.write("\nAdditional Notes\n")
        f.write("----------------\n")
        f.write("Training on even data.  One hot encoding [x,y] x pulses less than threshold and y greater than or equal to threshold\n")
