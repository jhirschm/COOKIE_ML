...
def main():
    ...
    model_save_dir = "/sdf/data/lcls/ds/prj/prjs2e21/results/COOKIE_ML_Output/denoising/run_07272024_trainedOne1Pulse/outputs_fromEvenDist/"
    ...
    best_model_path = "/sdf/data/lcls/ds/prj/prjs2e21/results/COOKIE_ML_Output/lstm_classifier/run_07262024_ypdf_0to1_3/evalOutputs_ximg0to1_2_denoisedMulti/autoencoder_best_model.pth"
