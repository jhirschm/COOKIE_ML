...
def main():
    ...
    best_model_path = "/sdf/data/lcls/ds/prj/prjs2e21/results/COOKIE_ML_Output/denoising/run_03122025_multiPulse_hourglass_maxpool/autoencoder_16x64_best_model.pth"
